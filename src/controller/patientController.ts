...
// Get patient ByID
export const getPatientsById = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
// delete Patient
export const deletePatientById = async (request: Request, response: Response, next: NextFunction) => {
    try {
